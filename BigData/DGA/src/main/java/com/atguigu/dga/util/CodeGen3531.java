...
public class CodeGen3531 {
    public static void main(String[] args) throws IOException {
        ...
        String jdbcUrl = "jdbc:mysql://127.0.0.1:3306/dga?characterEncoding=utf-8&useSSL=false";
        FastAutoGenerator.create(jdbcUrl, "root", "123321")
                .globalConfig(builder -> {
                    builder.author("-") //作者
                            .outputDir("D:\\Code\\JavaProject\\20240522java\\BigData0522\\DGA\\src\\main\\java") //输出路径(写到java目录)
